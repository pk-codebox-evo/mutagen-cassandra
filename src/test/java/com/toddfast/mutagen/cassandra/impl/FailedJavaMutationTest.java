...
public class FailedJavaMutationTest extends AbstractTest {
    ...
    private void firstMutationFailed() {
        mutate("mutations/tests/failed_java_mutation");
    ...
    private void secondMutationAbortedBecauseMutationStateIsFailed() {
        ...
        try {
            ...
            Assert.assertEquals("There is a failed mutation in database for script : M201501010002_WrongJavaScriptFile_1111.java[state=201501010002]",
                    e.getMessage());
        }
